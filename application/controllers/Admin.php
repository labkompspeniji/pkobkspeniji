...
class Admin extends CI_Controller
{
    ...
    function buathasil()
    {
        ...
        $pdf->Cell(180, 8, 'ORGANISASI SISWA INTRA SEKOLAH', 0, 0, 'C');
        $pdf->Ln(6);
        $pdf->SetFont('Times', 'B', 14);
        $pdf->Cell(10, 0, '', 0);
        $pdf->Cell(180, 7, 'SEKOLAH MENENGAH PERTAMA', 0, 0, 'C');
        $pdf->Ln(5);
        $pdf->Cell(10, 0, '', 0);
        $pdf->Cell(180, 7, 'NEGERI 1 BEJI', 0, 0, 'C');
        $pdf->Ln(5);
        $pdf->Cell(10, 0, '', 0);
        ...
        $pdf->Ln(5);
        $pdf->Cell(190, 0, 'PEMILIHAN KETUA OSIS BERBASIS KOMPUTER', 0, 0, 'C');
        $pdf->Ln(5);
        $pdf->Cell(190, 0, 'MASA BAKTI 2023/2024', 0, 0, 'C');
        ...
        $pdf->Ln(5);
        $pdf->MultiCell(190, 5, 'Demikian hasil perhitungan suara pemilihan ketua osis ' . $sekolah['nmSekolah'] . ' untuk dapat dijadikan patokan penentuan jabatan ketua osis periode 2023/2024', 0, 'J');

        $pdf->Ln(12);
        $pdf->Cell(120, 0, '', 0);
        $pdf->Cell(60, 6, 'Pasuruan, ' . tgl(date('Y-m_d')), 0, 0, 'J');
        $pdf->Ln(6);
        $pdf->Cell(120, 0, '', 0);
		...
		$pdf->Ln(50);
        $pdf->Cell(128, 0, '', 0);
        $pdf->Cell(60, 6, 'Fauzi Muhammad Anggah', 0, 0, 'J');
        $pdf->Ln(1);
        $pdf->Cell(120, 0, '', 0);
