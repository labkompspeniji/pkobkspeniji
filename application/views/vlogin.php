...
<head>
  ...
  <!-- Favicons -->
  <link href="<?= base_url('assets/template'); ?>/img/osis.png" rel="icon">
  <link href="<?= base_url('assets/template'); ?>/img/osis.png" rel="apple-touch-icon">
...
<body>
  ...
  <script>
    $.backstretch("<?= base_url('assets/template'); ?>/img/bg.jpg", {
      speed: 500
    });
  </script>
</body>
