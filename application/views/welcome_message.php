...
<head>
  ...
  <header class="header black-bg" style="padding-top: 10px;">
    ...
    <!--logo start-->
    <a href="<?= base_url(); ?>" class="logo"><b><span>P K O B K</span></b></a>
    <!--logo end-->
    <ul>
      <li>
  ...
  <!--header end-->
<body style="background-image: url(<?= base_url('assets/images/bg.jpg'); ?>); background-repeat:no-repeat; background-size:cover; background-position:center;" >
  ...
  <section class="container">
    <h2 class="text-center" style="color: white; font-weight: bolder">
      <br><br>PEMILIHAN KETUA OSIS BERBASIS KOMPUTER<br> CALON KETUA OSIS
    </h2>
    <h4 class="text-center" style="color: white; font-weight: bolder"><?= $sekolah->nmSekolah; ?> <br> Tahun Pelajaran 2023 - 2024</h4>
